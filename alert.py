...
def send_alert(sender_email, sender_password, recipient_email, video_path):
    ...
    try:
        ...
        msg['Subject'] = "Fall Detected Alert - Video Recording"
        body = (
            "Dear User,\n\n"
            "A fall was detected by your monitoring system. "
            "Please find the attached video for review.\n\n"
...
if __name__ == "__main__":
    ...
    video_path = "fall_detected.avi"  # Replace with your video file path
